...
export const PreviousMonthSummary: React.FC<PreviousMonthSummaryProps> = ({ projects, timeEntries }) => {
  ...
  return (
    <Box>
      ...
      <Typography variant="subtitle1" gutterBottom>
        {isEnglish ? 'Total Hours:' : '合計時間:'} {totalHours.toFixed(1)} {t('units.hours')}
      </Typography>
      ...
      {projectData.length > 0 ? (
        ...
        <Box sx={{ 
          ...
          <Typography variant="body1" color="text.secondary">
            {isEnglish ? 'No activity data for the previous month' : '先月の稼働データがありません'}
          </Typography>
        </Box>
      )}
    </Box>
