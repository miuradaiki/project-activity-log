      ...
      <CardContent sx={{ flexGrow: 1, pl: 3 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
          <Typography 
            ...
            sx={{ 
              fontWeight: 'bold',
              color: project.isArchived ? theme.palette.text.secondary : theme.palette.text.primary
            }}
          >
            {project.name}
          </Typography>
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', mt: 2 }}>
            <Box sx={{ position: 'relative', mr: 2 }}>
              <CircularProgress
                ...
                size={50}
                thickness={4}
                sx={{ color: theme.palette.mode === 'dark' ? theme.palette.grey[700] : theme.palette.grey[200] }}
              />
              <CircularProgress
                variant="determinate"
                value={progress}
