...
export const ProjectComparisonView: React.FC<ProjectComparisonViewProps> = ({
  ...
  const [selectedProjects, setSelectedProjects] = useState<string[]>(activeProjects);
  ...
  }, [selectedProjects, projects, timeEntries, startOfMonth, endOfMonth, theme]);
    ...
    >
      ...
      <Box sx={{ mb: 3 }}>
        <FormControl fullWidth size="small">
          <InputLabel id="project-comparison-select-label">比較するプロジェクト</InputLabel>
          <Select
                  ...
                  return (
                    <Chip 
                      ...
                      sx={{ 
                        ...
                        color: theme.palette.getContrastText(getProjectColor(index))
                      }}
                    />
                  );
                })}
          ...
          viewMode === 'bar' ? (
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <RechartsTooltip formatter={(value: number) => [`${value.toFixed(1)}時間`, '']} />
                <Legend />
