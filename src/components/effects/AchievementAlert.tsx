...
export const AchievementAlert: React.FC<AchievementAlertProps> = ({
  ...
  // 達成タイプに応じたメッセージ
  const title = achievementType === 'completed'
    ? '目標達成おめでとうございます！'
    : 'マイルストーン達成！';
    
  const message = achievementType === 'completed'
            ...
            <Box
              sx={{
                ...
                '@keyframes pulse': {
                  '0%': {
                    transform: 'scale(1)',
                    boxShadow: `0 0 0 0 ${achievementType === 'completed' 
                      ? theme.palette.primary.main + '80' 
                      : theme.palette.secondary.main + '80'}`,
                  },
                  '70%': {
                    transform: 'scale(1.05)',
                    boxShadow: `0 0 0 10px ${achievementType === 'completed' 
